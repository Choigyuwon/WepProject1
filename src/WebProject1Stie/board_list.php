        ...
        <table class="table-bordered" border = "1" align="center" bordercolor="black" width ="800" height="300">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?php
                            echo "<a class='click-board-title' href='board_detail.php?board_no=".$row["board_no"]."'>";
                    ...
                    <td>
                        ...
                        <?php
                            echo "<td><a class='click-board-mod' href='board_update_form.php?board_no=".$row["board_no"]."'>
Modify</a></td>";
                            echo "<td><a class='click-board-del' href='board_delete_form.php?board_no=".$row["board_no"]."'>Delete</a></td>";
                        ?>
                </tr>
            <?php
                }
        ...
        <?php
            ...
            if($currentPage > 1 ) { 
                ...
                echo "<a class='click-board-page' href ='board_list.php?currentPage=".($currentPage-1)."'>of</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            }
            ...
            if($currentPage < $lastPage) { 
                ...
                echo "<a class='click-board-page' href='board_list.php?currentPage=".($currentPage+1)."'>Next</a>";
            }
            mysqli_close($conn);
        ?>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="click-board-write" href="board_add_form.php">Add Write</a><br>
		<a class="click-board-write" href="bookmain.html">GoMain</a>
    </body>
</html>
